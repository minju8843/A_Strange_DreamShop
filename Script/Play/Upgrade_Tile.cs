...
public class Upgrade_Tile : MonoBehaviour
{
    // 플레이어 무브 스크립트에서 할 거
    ...
    public void Update()
    {
        ...
        if (good_bad.Goood_Count > 2 && good_bad.Ccoin_Count > 0)//코인이 1개 이상
        {
        ...
        if (good_bad.Goood_Count > 2 && good_bad.Ccoin_Count == 0)//코인이 0개
        {
            Double_Player_Tile[0].SetActive(false);
            Double_Player_Tile[1].SetActive(true);
            Double_Player_Tile_Upgrade.SetActive(true);
        ...
        if (good_bad.Goood_Count < 3 && good_bad.Ccoin_Count > 0)//코인이 1개 이상
        {
        ...
        if (good_bad.Goood_Count < 3 && good_bad.Ccoin_Count == 0)//코인이 0개
        {
            Double_Player_Tile[0].SetActive(true);
            Double_Player_Tile[1].SetActive(false);
            Double_Player_Tile_Upgrade.SetActive(false);
        ...
        if ((good_bad.Goood_Count > 2 || good_bad.Goood_Count < 3) && Double_Player_Tile[2].activeSelf == true && good_bad.Ccoin_Count > 0)//코인이 1개 이상
        {
        ...
        if ((good_bad.Goood_Count > 2 || good_bad.Goood_Count < 3) && Double_Player_Tile[2].activeSelf == true && good_bad.Ccoin_Count == 0)//코인이 0개
        {
            Double_Player_Tile[2].SetActive(true);
            Double_Player_Tile_Upgrade.SetActive(false);
            Double_Player_Tile_Upgrade_Will_No.SetActive(false);
        ...
        if ((good_bad.Goood_Count > 2 || good_bad.Goood_Count < 3) && Diagonal_Line_Tile[2].activeSelf == true && good_bad.Ccoin_Count > 0)//코인이 1개 이상
        {
            //여기부터는 대각선
            Diagonal_Line_Tile[2].SetActive(true);
            Diagonal_Line_Tile_Upgrade.SetActive(false);
        ...
        if ((good_bad.Goood_Count > 2 || good_bad.Goood_Count < 3) && Diagonal_Line_Tile[2].activeSelf == true && good_bad.Ccoin_Count == 0)//코인이 0개
        {
            //여기부터는 대각선
            Diagonal_Line_Tile[2].SetActive(true);
            Diagonal_Line_Tile_Upgrade.SetActive(false);
        ...
        if ((good_bad.Goood_Count > 2 || good_bad.Goood_Count < 3) && Vertex_Tile[2].activeSelf == true && good_bad.Ccoin_Count > 0)//코인이 1개 이상
        {
            //여기부터는 꼭짓점
            Vertex_Tile[2].SetActive(true);
            Vertex_Tile_Upgrade.SetActive(false);
        ...
        if ((good_bad.Goood_Count > 2 || good_bad.Goood_Count < 3) && Vertex_Tile[2].activeSelf == true && good_bad.Ccoin_Count == 0)//코인이 0개
        {
            //여기부터는 꼭짓점
            Vertex_Tile[2].SetActive(true);
            Vertex_Tile_Upgrade.SetActive(false);
        ...
        if ((good_bad.Goood_Count > 2 || good_bad.Goood_Count < 3) && Speciality_Tile[2].activeSelf == true && good_bad.Ccoin_Count > 0)//코인이 1개 이상
        {
            //여기부터는 스페셜티
            Speciality_Tile[2].SetActive(true);
            Speciality_Tile_Upgrade.SetActive(false);
        ...
        if ((good_bad.Goood_Count > 2 || good_bad.Goood_Count < 3) && Speciality_Tile[2].activeSelf == true && good_bad.Ccoin_Count == 0)//코인이 0개
        {
            //여기부터는 스페셜티
            Speciality_Tile[2].SetActive(true);
            Speciality_Tile_Upgrade.SetActive(false);
    ...
    {//게임말 2배 타일을 활성화하시겠습니까? 
     //->네
        ...
        for (int i = 0; i < 3; i++)
        {
            good_bad.Goood_Count--;//굿 추가
            good_bad.Update_Good_Count();//굿 추가 출력 코드
        }
    ...
    {//왼쪽 아래 코인 버튼 눌렀을 때
        ...
        if (good_bad.Ccoin_Count > 0)//코인이 1개 이상 있는 경우
        {
        ...
        if (good_bad.Ccoin_Count == 0 && B_Count.Click_Count > 3)
        {
    ...
    public void Plus_Coin()//사용할 코인 개수 늘리기
    {
        ...
        if ((Ccoin_Count > 2 || Ccoin_Count == 2) && ( good_bad.Ccoin_Count >2 || good_bad.Ccoin_Count == 2))//실제 동전 개수가 3개 이상일 때
        {
            Ccoin_Count = 2;
            Coin_Count.text = " 0" + Ccoin_Count.ToString();
        ...
        if(good_bad.Ccoin_Count == 1 && (Ccoin_Count > 2 || Ccoin_Count == 2 || Ccoin_Count == 1))
        {//실제 동전 개수가 1개일 때
            Ccoin_Count = 1;
            Coin_Count.text = " 0" + Ccoin_Count.ToString();
        }
    ...
    public void Use_This_Coin_Ok()//코인 이정도 쓰겠다고 확인버튼 누르는 코드
    {
        ...
        //코인 개수는 감소시키기
        good_bad.Ccoin_Count = good_bad.Ccoin_Count - Ccoin_Count;//코인 개수 다시 정정
        //사용한 만큼 감소시키기
